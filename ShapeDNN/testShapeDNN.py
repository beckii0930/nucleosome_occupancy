...
print("accuracy_score", accuracy_score(y_test.T,tpreds))
print("precision_score", precision_score(y_test.T,tpreds))
print("recall_score", recall_score(y_test.T,tpreds))
