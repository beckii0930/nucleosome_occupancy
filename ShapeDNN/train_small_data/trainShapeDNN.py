...
X_train_big, y_train_big = utils.shuffle(X_train_og, y_train_og)
#X_train, y_train = sklearn.utils.shuffle(X_train_og, y_train_og)
X_train=X_train_big[0:20]
y_train=y_train_big[0:20]
...
print(validmat['Test_data'][0:10].shape)
print(f"X_train.shape {X_train.shape}")
print(f"y_train.shape {y_train.shape}")

print(validmat['Test_data'].shape)
print(validmat['Test_labels'].shape)
X_val_big, y_val_big = utils.shuffle(validmat['Test_data'],validmat['Test_labels'].T)
X_val=X_val_big[0:10]
y_val=y_val_big[0:10]
