...
checkpointer1 = ModelCheckpoint(filepath="./model/tbinet_loss.temp_check.hdf5", verbose=1, save_best_only=False)
...
history = model.fit(X_train, y_train, batch_size=100, epochs=1, shuffle=True, verbose=1, validation_data=(validmat['Test_data'],validmat['Test_labels'].T), callbacks=[checkpointer1,checkpointer2,earlystopper])
