...
# chagne padding to same to use 0 padding
# output = Conv1D(320,kernel_size=10,padding="valid",activation="relu")(sequence_input)
output = Conv1D(320,kernel_size=10,padding="same",activation="relu")(sequence_input)
# try average pooling 
# output = MaxPooling1D(pool_size=5, strides=1)(output)
output = AveragePooling1D(pool_size=5, strides=1)(output)
...
#BiLSTM Layer
## TODO: remove LSTM if not, try to change weights to positive 
...
## TODO: change weights to positive 
